...
class TensorProto PROTOBUF_FINAL :
 ...
 public:
  ...
  void _internal_set_float8_val(const std::string& value);
  ...
  ::tensorboard::TensorShapeProto* release_tensor_shape();
...
inline void TensorProto::set_tensor_content(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:tensorboard.TensorProto.tensor_content)
}
inline void TensorProto::set_tensor_content(const char* value) {
  ...
  tensor_content_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:tensorboard.TensorProto.tensor_content)
}
inline void TensorProto::set_tensor_content(const void* value,
  ...
  // @@protoc_insertion_point(field_set_pointer:tensorboard.TensorProto.tensor_content)
}
...
inline const std::string& TensorProto::float8_val() const {
  // @@protoc_insertion_point(field_get:tensorboard.TensorProto.float8_val)
  return _internal_float8_val();
}
inline void TensorProto::set_float8_val(const std::string& value) {
  _internal_set_float8_val(value);
  // @@protoc_insertion_point(field_set:tensorboard.TensorProto.float8_val)
}
inline std::string* TensorProto::mutable_float8_val() {
  // @@protoc_insertion_point(field_mutable:tensorboard.TensorProto.float8_val)
  return _internal_mutable_float8_val();
}
...
inline void TensorProto::_internal_set_float8_val(const std::string& value) {
  ...
  float8_val_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void TensorProto::set_float8_val(std::string&& value) {
  
  float8_val_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:tensorboard.TensorProto.float8_val)
}
inline void TensorProto::set_float8_val(const char* value) {
  ...
  float8_val_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:tensorboard.TensorProto.float8_val)
}
inline void TensorProto::set_float8_val(const void* value,
  ...
  float8_val_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:tensorboard.TensorProto.float8_val)
}
inline std::string* TensorProto::_internal_mutable_float8_val() {
  
  return float8_val_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* TensorProto::release_float8_val() {
  // @@protoc_insertion_point(field_release:tensorboard.TensorProto.float8_val)
  return float8_val_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TensorProto::set_allocated_float8_val(std::string* float8_val) {
  ...
  float8_val_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), float8_val,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:tensorboard.TensorProto.float8_val)
}
...
inline void VariantTensorDataProto::set_type_name(std::string&& value) {
  ...
  type_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:tensorboard.VariantTensorDataProto.type_name)
}
inline void VariantTensorDataProto::set_type_name(const char* value) {
  ...
  type_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:tensorboard.VariantTensorDataProto.type_name)
}
inline void VariantTensorDataProto::set_type_name(const char* value,
    size_t size) {
  ...
  type_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:tensorboard.VariantTensorDataProto.type_name)
}
...
inline void VariantTensorDataProto::set_metadata(std::string&& value) {
  ...
  metadata_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:tensorboard.VariantTensorDataProto.metadata)
}
inline void VariantTensorDataProto::set_metadata(const char* value) {
  ...
  metadata_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:tensorboard.VariantTensorDataProto.metadata)
}
inline void VariantTensorDataProto::set_metadata(const void* value,
  ...
  metadata_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:tensorboard.VariantTensorDataProto.metadata)
}
