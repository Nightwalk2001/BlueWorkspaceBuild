...
inline void TensorShapeProto_Dim::set_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:tensorboard.TensorShapeProto.Dim.name)
}
inline void TensorShapeProto_Dim::set_name(const char* value) {
  ...
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:tensorboard.TensorShapeProto.Dim.name)
}
inline void TensorShapeProto_Dim::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:tensorboard.TensorShapeProto.Dim.name)
}
