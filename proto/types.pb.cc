...
static void InitDefaultsscc_info_SerializedDType_types_2eproto() {
  ...
  {
    void* ptr = &::tensorboard::_SerializedDType_default_instance_;
    new (ptr) ::tensorboard::SerializedDType();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::tensorboard::SerializedDType::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SerializedDType_types_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SerializedDType_types_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_types_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::tensorboard::SerializedDType, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::tensorboard::SerializedDType, datatype_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::tensorboard::SerializedDType)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tensorboard::_SerializedDType_default_instance_),
};
...
const char descriptor_table_protodef_types_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "DType\022\'\n\010datatype\030\001 \001(\0162\025.tensorboard.Da"
  ...
  "IANT_REF\020y\022\021\n\rDT_UINT32_REF\020z\022\021\n\rDT_UINT"
  "64_REF\020{\022\026\n\022DT_FLOAT8_E5M2_REF\020|\022\030\n\024DT_F"
  "LOAT8_E4M3FN_REF\020}\022\020\n\013DT_INT4_REF\020\201\001\022\021\n\014"
  "DT_UINT4_REF\020\202\001Bz\n\030org.tensorflow.framew"
  "orkB\013TypesProtosP\001ZLgithub.com/tensorflo"
  "w/tensorflow/tensorflow/go/core/framewor"
  "k/types_go_proto\370\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_types_2eproto = {
  false, false, descriptor_table_protodef_types_2eproto, "types.proto", 1187,
...
SerializedDType::SerializedDType(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:tensorboard.SerializedDType)
}
SerializedDType::SerializedDType(const SerializedDType& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  datatype_ = from.datatype_;
  // @@protoc_insertion_point(copy_constructor:tensorboard.SerializedDType)
}
...
SerializedDType::~SerializedDType() {
  // @@protoc_insertion_point(destructor:tensorboard.SerializedDType)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:tensorboard.SerializedDType)
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    CHK_(ptr);
    switch (tag >> 3) {
      // .tensorboard.DataType datatype = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ::PROTOBUF_NAMESPACE_ID::uint64 val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_datatype(static_cast<::tensorboard::DataType>(val));
...
::PROTOBUF_NAMESPACE_ID::uint8* SerializedDType::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:tensorboard.SerializedDType)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tensorboard.SerializedDType)
  return target;
}

size_t SerializedDType::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tensorboard.SerializedDType)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:tensorboard.SerializedDType)
  GOOGLE_DCHECK_NE(&from, this);
  const SerializedDType* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<SerializedDType>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:tensorboard.SerializedDType)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:tensorboard.SerializedDType)
    MergeFrom(*source);
  }
}

void SerializedDType::MergeFrom(const SerializedDType& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:tensorboard.SerializedDType)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:tensorboard.SerializedDType)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:tensorboard.SerializedDType)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::tensorboard::SerializedDType* Arena::CreateMaybeMessage< ::tensorboard::SerializedDType >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorboard::SerializedDType >(arena);
}
