...
PROTOBUF_NAMESPACE_OPEN
template<> ::tensorboard::SerializedDType* Arena::CreateMaybeMessage<::tensorboard::SerializedDType>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorboard {
...
class SerializedDType PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorboard.SerializedDType) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorboard.SerializedDType";
  }
  protected:
  ...
  void clear_datatype();
  ::tensorboard::DataType datatype() const;
  void set_datatype(::tensorboard::DataType value);
  private:
  ::tensorboard::DataType _internal_datatype() const;
  void _internal_set_datatype(::tensorboard::DataType value);
  public:
...
inline ::tensorboard::DataType SerializedDType::_internal_datatype() const {
  return static_cast< ::tensorboard::DataType >(datatype_);
}
inline ::tensorboard::DataType SerializedDType::datatype() const {
  // @@protoc_insertion_point(field_get:tensorboard.SerializedDType.datatype)
  return _internal_datatype();
}
inline void SerializedDType::_internal_set_datatype(::tensorboard::DataType value) {
  
  datatype_ = value;
}
inline void SerializedDType::set_datatype(::tensorboard::DataType value) {
  _internal_set_datatype(value);
  // @@protoc_insertion_point(field_set:tensorboard.SerializedDType.datatype)
}
